...
public class ContatosControle {
    ...
    static{
        ...
        LISTA_CONTATOS.add(new Contato("3", "Normandes", "+55 34 0000 0000"));
        LISTA_CONTATOS.add(new Contato("4", "Thiago", "+55 34 0000 0000"));
        LISTA_CONTATOS.add(new Contato("5", "Alexandre", "+55 34 0000 0000"));
    }
    ...
    public String cadastrar (Contato contato){
        ...
        contato.setId(id); //Equivale a: contato.setId(id);
    ...
    @PutMapping("/contatos/{id}")  //@PutMapping("/contatos/{id}") não funciona
